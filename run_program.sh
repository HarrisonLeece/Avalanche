...
#run a spleeter command to turn ./wavs/input.wav into multiple tracks
echo "Running a spleeter separation on ./wavs/input.wav"
spleeter separate -o ./spleeter_tracks/input4stem -p spleeter:4stems ./wavs/input.wav    
